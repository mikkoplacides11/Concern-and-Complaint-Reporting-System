<title>Concern and Complaint Reporting System | Manage Subscriber</title>
<?php 
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Subscriber Add</li>
          </ol>
        </div>
      </div>
    </div>
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-lg-10 col-md-10 col-sm-9 col-12">
                  <div class="form-group">
                    <span class="text-dark"><b>Subscriber's photo</b></span>
                    <div class="input-group">
    ...
    <div class="container-fluid">
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
            <li class="breadcrumb-item active">Subscriber Update</li>
          </ol>
        </div>
      </div>
    </div>
