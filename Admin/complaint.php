                  ...
                  <tbody id="users_data">
                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          <button type="button" class="btn bg-warning btn-xs" data-toggle="modal" data-target="#updateStatus<?php echo $row['complaint_ID']; ?>"><i class="fas fa-pencil-alt"></i> Status</button>
